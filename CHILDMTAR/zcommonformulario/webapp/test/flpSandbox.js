		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Formulario Comun",
									"targetURL": "#zcommonformulario-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zcommonformulario-display": {
								"semanticObject": "zcommonformulario",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zcommonformulario",
									"url": sap.ui.require.toUrl("zcommonformulario")
								}
							}
						}
					}
