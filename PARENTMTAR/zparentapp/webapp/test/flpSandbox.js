		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Aplicacion Padre",
									"targetURL": "#xtscomzparentapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"xtscomzparentapp-display": {
								"semanticObject": "xtscomzparentapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=xts.com.zparentapp",
									"url": sap.ui.require.toUrl("xts/com/zparentapp")
								}
							}
						}
					}
